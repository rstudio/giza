...
(function(){
  this.save = function(path, val, type){
    ...
    this.$bubbler.emit(path, 'pre-update', type);
    ...
    // Fire update regardless of whether or not it's new
    this.$bubbler.emit(path, 'update', type);
  }
  ...
  this.delete = function(path){
    ...
    this.$bubbler.emit(path, 'pre-delete', this.getType(path));
    ...
    this.$bubbler.emit(path, 'delete', type);
    return toReturn;
  }
